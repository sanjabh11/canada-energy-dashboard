...
The 95% gate requires current or historical, not future-dated, evidence rows; exact privacy-screen statuses; reviewer roles on confidence-moving rows; exact reviewer statuses rather than negated prose; and distinct SHA-256 evidence artifacts across accepted buyer proof-pack rows.
