...
The public release status now also exposes launch evidence validation and objective completion audit as public-safe predeploy handles. These handles check manifest structure, proof-boundary consistency, required launch deliverables, blocked P0/P1 gates, manual-stop rows, and next proof commands only; they do not grant production approval, prove buyer acceptance, deploy, mutate live services, prove current hosted/live parity, prove commercial launch readiness, clear source readiness, or create launch readiness.
