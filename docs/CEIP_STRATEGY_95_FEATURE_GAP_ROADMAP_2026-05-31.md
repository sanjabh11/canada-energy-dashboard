...
| Forecast metrics can overstate accuracy. | Mitigated for local/public evidence by baselines, mandatory baseline-win failure notes, multi-dataset benchmark packaging, and pilot validator. | Do not make stronger prediction claims until buyer evidence gate passes. |
