...
For wedge-specific retained extracts, use prepare:ga-ici-5cp-artifact with --peak-tracker-file or --peak-tracker-url for Ontario 5CP evidence, add --historical-actuals-file when comparing against prior top-five actuals, and use prepare:byo-csv-proof-artifact for local CSV privacy-screen evidence.
```
