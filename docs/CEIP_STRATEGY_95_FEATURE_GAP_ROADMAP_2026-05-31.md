...
| Commercial source guard | `pnpm run check:commercial-source` passed for 10 active docs and 26 historical docs. | Strong local proof | Commercial doc ratings and route mappings are guarded. |
