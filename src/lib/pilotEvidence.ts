...
export const pilotEvidenceRequirements: PilotEvidenceRequirement[] = [
  ...
  },
  {
    ...
    minimumInput: 'Redacted CSV sample or local-only owner-approved CSV whose retained extract contains schema, completeness, and direct-identifier screen results only.',
    ...
    route: '/byo-csv-proof',
    acceptance: [
      'Retained artifact records schema, completeness, direct-identifier findings, and no retained raw values.',
      'Confidence-gate readiness is false when direct identifiers are found.',
