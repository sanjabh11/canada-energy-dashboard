      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card shadow p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">State of Charge Trend</h3>
          ...
          {/* Action Distribution */}
          <div className="card shadow p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">Action Distribution</h3>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="card shadow p-6">
          <h3 className="text-lg font-semibold text-primary mb-4">Recent Dispatch Decisions</h3>
            ...
            {logs.slice(0, 10).map(log => (
              <div key={log.id} className="flex items-start justify-between border-b border-slate-100 pb-3">
                ...
                <div className="text-right">
                  <div className="text-sm font-medium text-primary">${log.expected_revenue_cad.toFixed(0)}</div>
                  <div className="text-xs text-tertiary">{new Date(log.dispatched_at).toLocaleTimeString()}</div>
                </div>
              </div>
            ))}
          </div>
