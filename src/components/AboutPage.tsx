    ...
    <div className="min-h-screen bg-primary">
      ...
      <div className={`${CONTAINER_CLASSES.page} py-16 space-y-16`}>
          ...
          <div className="card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <p className="text-sm text-secondary">Open access to energy data with clear provenance and quality indicators</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-secondary">Multi-stakeholder engagement including Indigenous communities and industry partners</p>
              </div>
              <div className="text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold text-primary mb-6">Advanced Technology Stack</h2>
          ...
          <div className="card p-8">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center justify-between p-3 bg-secondary rounded-lg border border-[var(--border-subtle)]"
                >
        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="bg-secondary p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Users className="h-10 w-10 text-slate-600" />
                </div>
                <h3 className="font-semibold text-primary mb-2">Energy Experts</h3>
                <p className="text-sm text-secondary">Deep domain knowledge in Canadian energy markets and regulations</p>
              </div>
              <div className="text-center">
                <div className="bg-secondary p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Target className="h-10 w-10 text-slate-600" />
                </div>
                <h3 className="font-semibold text-primary mb-2">Data Scientists</h3>
                <p className="text-sm text-secondary">Advanced analytics and machine learning for predictive insights</p>
              </div>
              <div className="text-center">
                <div className="bg-secondary p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Shield className="h-10 w-10 text-slate-600" />
                </div>
                <h3 className="font-semibold text-primary mb-2">Engineers</h3>
                <p className="text-sm text-secondary">Scalable architecture and robust security implementation</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="card p-8">
            ...
            <h2 className="text-3xl font-bold text-primary mb-6">Certifications & Compliance</h2>
            <p className="text-lg text-secondary leading-relaxed mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="text-center p-4 border border-[var(--border-subtle)] rounded-lg hover:border-[var(--border-medium)] transition-colors bg-secondary/60"
                >
                  ...
                  <p className="text-xs text-secondary">{cert.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="card relative overflow-hidden text-center border border-[var(--border-subtle)]">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-900/40 via-indigo-900/40 to-slate-900/40 pointer-events-none" />
          <div className="relative z-10 p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="bg-secondary hover:bg-secondary/80 text-primary px-6 py-3 rounded-lg font-medium transition-colors border border-[var(--border-subtle)]"
              >
                Explore Platform
              </button>
            </div>
