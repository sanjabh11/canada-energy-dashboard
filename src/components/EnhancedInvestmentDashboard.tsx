    ...
    <div className="space-y-6">
      ...
      <div className="card shadow p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div>
              <h2 className="text-2xl font-bold text-primary">Investment Decision Support</h2>
              <p className="text-secondary">Multi-criteria analysis and portfolio optimization for energy projects</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-secondary rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-electric font-medium">Total Investment</p>
          ...
          <div className="bg-secondary rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-success font-medium">Average IRR</p>
          ...
          <div className="bg-secondary rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-electric font-medium">Avg ESG Score</p>
      ...
      {viewMode === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card shadow p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">Project Status Distribution</h3>
          ...
          <div className="card shadow p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">Risk vs Return Analysis</h3>
            <ResponsiveContainer width="100%" height={300}>
              <ScatterChart>
                <CartesianGrid />
                <XAxis 
          ...
          <div className="card shadow p-6 lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-primary">Optimized Portfolio Recommendations</h3>
              <Calculator className="text-tertiary" size={20} />
            </div>
                ...
                <div key={project.id} className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${
                      index === 0 ? 'bg-secondary0' : index === 1 ? 'bg-secondary0' : 'bg-secondary0'
                    }`}>
                      {index + 1}
                    </div>
                    <div>
                      <h4 className="font-medium text-primary">{project.project_name}</h4>
                      <p className="text-sm text-secondary">{project.project_type} • ${(project.total_investment_cad / 1000000).toFixed(1)}M</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-medium text-primary">{project.financial_metrics.irr_percent?.toFixed(1)}% IRR</p>
                    <p className="text-sm text-secondary">Risk: {project.risk_assessment.overall_risk_score}/100</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {viewMode === 'projects' && (
        <div className="card shadow p-6">
          <h3 className="text-lg font-semibold text-primary mb-4">Investment Projects</h3>
          <div className="space-y-4">
            {projects.map((project) => (
              <div key={project.id} className="border border-[var(--border-subtle)] rounded-lg p-4 hover:border-[var(--border-medium)] transition-colors">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h4 className="font-medium text-primary">{project.project_name}</h4>
                    <p className="text-sm text-secondary mt-1">{project.project_type} • ${(project.total_investment_cad / 1000000).toFixed(1)}M CAD</p>
      ...
      {showAddProject && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="card p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            {/* ESG Scores */}
            <div className="mt-6">
              <h5 className="font-medium text-secondary mb-3">ESG Scores (0-100)</h5>
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm text-secondary mb-1">Environmental</label>
                  <input
                    type="number"
                    min="0"
                    max="100"
                ...
                <div>
                  <label className="block text-sm text-secondary mb-1">Social</label>
                  <input
                    type="number"
                    min="0"
                    max="100"
                ...
                <div>
                  <label className="block text-sm text-secondary mb-1">Governance</label>
                  <input
                    type="number"
                    min="0"
                    max="100"
