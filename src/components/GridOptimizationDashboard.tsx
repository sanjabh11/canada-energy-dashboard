      ...
      <div className={CONTAINER_CLASSES.page}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="card shadow p-6">
            <h3 className="text-xl font-semibold text-primary mb-4">Demand vs Supply (24h)</h3>
          ...
          <div className="card shadow p-6">
            <h3 className="text-xl font-semibold text-primary mb-4">Grid Stability Metrics</h3>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card shadow p-6">
            <h3 className="text-xl font-semibold text-primary mb-4">Recommendations by Priority</h3>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
