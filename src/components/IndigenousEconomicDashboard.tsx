...
const IndigenousEconomicDashboard: React.FC = () => {
  ...
  if (error || !data) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="bg-secondary border border-red-200 rounded-lg p-6 max-w-md">
...
const StatCard: React.FC<StatCardProps> = ({ icon, title, value, subtitle, color }) => {
  ...
  return (
    <div className="card shadow border border-gray-200 p-6">
...
const OverviewSection: React.FC<{ data: DashboardData }> = ({ data }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-secondary border-2 border-purple-200 rounded-lg p-6">
        <div className="flex items-start gap-4">
          <CheckCircle className="h-6 w-6 text-electric flex-shrink-0 mt-1" />
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <p className="text-sm text-electric font-medium">Communities Participating</p>
                <p className="text-2xl font-bold text-purple-900">{data.summary.total_communities}+</p>
              </div>
              <div>
                <p className="text-sm text-electric font-medium">Total Equity Invested</p>
                <p className="text-2xl font-bold text-purple-900">
                  ${(data.summary.total_equity_value / 1e6).toFixed(0)}M
                </p>
              </div>
              <div>
                <p className="text-sm text-electric font-medium">Annual Economic Benefit</p>
                <p className="text-2xl font-bold text-purple-900">
...
const EquitySection: React.FC<{ data: DashboardData }> = ({ data }) => {
  return (
    <div className="space-y-6">
            ...
            <tbody className="divide-y divide-gray-200">
              {data.equity_projects.map((project) => (
                <tr key={project.id} className="text-sm hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-right font-semibold text-electric">
      ...
      {/* Key Insights */}
      <div className="bg-secondary border border-blue-200 rounded-lg p-6">
...
const AgreementsSection: React.FC<{ data: DashboardData }> = ({ data }) => {
  return (
    <div className="space-y-6">
      ...
      {/* Key Insights */}
      <div className="bg-secondary border border-green-200 rounded-lg p-6">
