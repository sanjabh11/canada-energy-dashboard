...
export const CERComplianceDashboard: React.FC = () => {
  ...
  const getComplianceStatusColor = (status: string) => {
    switch (status) {
      case 'compliant': return 'text-success bg-secondary border-green-200';
      case 'non_compliant': return 'text-danger bg-secondary border-red-200';
      case 'under_review': return 'text-warning bg-secondary border-yellow-200';
      case 'conditional': return 'text-electric bg-secondary border-purple-200';
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-secondary">Canada Energy Regulator • Regulatory Compliance Monitoring</p>
            </div>
      ...
      {viewMode === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card shadow p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">Compliance Status Distribution</h3>
          ...
          <div className="card shadow p-6">
            <h3 className="text-lg font-semibold text-primary mb-4">Safety Performance by Facility Type</h3>
                ...
                return (
                  <div key={type} className="flex items-center justify-between p-3 bg-secondary rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-secondary">({facilities.length} facilities)</span>
                    </div>
        ...
        <div className="card shadow p-6">
          ...
          <div className="space-y-4">
            {filteredRecords.map((record) => (
              <div key={record.id} className="border border-[var(--border-subtle)] rounded-lg p-4 hover:border-[var(--border-medium)] transition-colors">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="card p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Violations */}
              <div>
                <h5 className="font-medium text-primary mb-3">Violations ({selectedRecord.violations.length})</h5>
                {selectedRecord.violations.length > 0 ? (
                  <div className="space-y-3">
                    {selectedRecord.violations.map((violation) => (
                      <div key={violation.violation_id} className="border border-[var(--border-subtle)] rounded-lg p-3">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {selectedRecord.environmental_conditions.map((condition) => (
                    <div key={condition.condition_id} className="border border-[var(--border-subtle)] rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
