      ...
      <div className={CONTAINER_CLASSES.page}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="card shadow p-6">
            ...
            <h3 className="text-lg font-semibold text-primary mb-2">Active Incidents</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          {/* Threat Risk Matrix */}
          <div className="card shadow p-6">
            <h3 className="text-xl font-semibold text-primary mb-4">Threat Risk Matrix</h3>
          ...
          {/* Incident Timeline */}
          <div className="card shadow p-6">
            <h3 className="text-xl font-semibold text-primary mb-4">Incident Timeline (24h)</h3>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="card shadow p-6">
            <h3 className="text-xl font-semibold text-primary mb-4">Threat Types Distribution</h3>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={threatTypeData}
        ...
        <div className="mt-8 card shadow p-6">
          <h3 className="text-xl font-semibold text-primary mb-4">Recent Security Incidents</h3>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-[var(--border-subtle)]">
                {incidents.slice(0, 10).map((incident) => (
                  <tr key={incident.id} className="hover:bg-secondary">
