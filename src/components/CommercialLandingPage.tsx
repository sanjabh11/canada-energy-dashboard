...
export function CommercialLandingPage() {
  ...
  useEffect(() => {
    trackEvent('tier_hero_view', { source: 'homepage' });
  }, []);
  ...
  return (
    ...
    >
      ...
      <main id="main-content">
              ...
              <Link to="/" className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-300">
                    Prediction inside budget-owned energy workflows
                  </div>
                </div>
              </Link>
            ...
            <div className="grid gap-12 py-16 lg:grid-cols-[1.3fr_0.9fr] lg:py-24">
              <div>
                ...
                <h1 className="max-w-4xl text-4xl font-semibold leading-tight text-white md:text-6xl">
                  Sell the energy workflow that owns a budget, not the prediction demo that gets
                  admired and parked.
                </h1>
                <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-300">
                  CEIP now leads with ten proof packs that buyers can understand in under ninety
                  seconds: utility planning, forecast trust reports, regulatory filing, Ontario
                  GA/ICI peak-risk support, BYO-CSV privacy proof, TIER decisions, credit banking,
                  asset triage, security review, and billing checks. Prediction stays central, but
                  only where it changes a filing, decision-support memo, capital plan, security
                  review, or invoice proof.
                </p>
        ...
        <section className="border-b border-cyan-400/20 bg-cyan-400/5">
            ...
            <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <h2 className="mt-1 text-xl font-semibold text-white">
                  3-Pathway CFO Memo — Fund vs Credits vs Direct Investment
                </h2>
                <p className="mt-1 text-sm text-slate-300">
                  Source-dated provenance, board-ready export. Not a spreadsheet printout.
                </p>
              </div>
              <div className="flex gap-3">
                <Link
                  to="/tier-compliance"
                  onClick={() => trackEvent('tier_cta_click', { destination: '/tier-compliance' })}
                ...
                >
                  TIER Landing Page <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  to="/roi-calculator"
                  onClick={() => trackEvent('tier_cta_click', { destination: '/roi-calculator' })}
                  className="inline-flex items-center gap-2 rounded-lg border border-white/20 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-white/10"
                >
                  ROI Calculator
                </Link>
              </div>
                ...
                {activeWedges.map((wedge) => (
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <Link
                        to={wedge.href}
                        className="rounded-full border border-cyan-300/25 px-4 py-2 text-sm font-medium text-cyan-100 transition hover:bg-cyan-300/10"
                      >
                        View page
                      </Link>
                    </div>
        ...
        <section id="proof" className="border-b border-white/10 bg-slate-900/70">
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-300">
              Forecast benchmarking, utility-security disclosure, and pilot-readiness proof stay
              visible. The broad dashboard, sandbox connector demo, and illustrative API-doc surface
              are intentionally secondary.
            </p>
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr]">
                <div>
                  ...
                  <p className="mt-4 max-w-2xl text-base leading-7 text-slate-200">
                    Page one now explains what CEIP sells before it asks for attention. It
                    foregrounds budget-owned workflows, acknowledges where proof is strong, and
                    keeps demo-heavy or fallback-heavy surfaces out of the primary conversion path.
                  </p>
                </div>
