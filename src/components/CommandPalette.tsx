    ...
    items: [
      {
        ...
        keywords: 'main home overview grid',
      },
      {
        label: 'Energy Facility Map',
        path: '/energy-map',
        icon: Globe,
        keywords: 'map gis geographic facilities maplibre',
      },
      {
        label: 'Analytics & Trends',
        path: '/analytics',
        icon: TrendingUp,
        keywords: 'charts trends analysis metrics',
      },
      {
        label: 'Data Freshness',
        path: '/data-freshness',
        icon: Activity,
        keywords: 'stale freshness update source',
      },
      {
        label: 'Status Page',
        path: '/status',
        icon: Activity,
        keywords: 'ops health system status',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: TrendingUp,
        keywords: 'load forecast ontario prediction',
      },
      {
        label: 'Utility Demand Forecast',
        path: '/utility-demand-forecast',
        icon: TrendingUp,
        keywords: 'utility planning load forecast',
      },
      {
        label: 'Forecast Benchmarking',
        path: '/forecast-benchmarking',
        icon: TrendingUp,
        keywords: 'benchmark evaluation mae mape tsfm',
      },
      {
        label: 'TSFM Benchmarks',
        path: '/tsfm-benchmarks',
        icon: Cpu,
        keywords: 'foundation model zero-shot benchmark',
      },
      {
        label: 'Scenario Workbench',
        path: '/scenario-workbench',
        icon: Cpu,
        keywords: 'scenario analysis what-if',
      },
    ],
  },
  {
    ...
    items: [
      {
        label: 'TIER Compliance Landing',
        path: '/tier-compliance',
        icon: Leaf,
        keywords: 'tier compliance alberta carbon',
      },
      {
        label: 'TIER ROI Calculator',
        path: '/roi-calculator',
        icon: Calculator,
        keywords: 'tier roi calculator savings',
      },
      {
        label: 'Credit Banking',
        path: '/credit-banking',
        icon: DollarSign,
        keywords: 'tier credit banking audit ledger',
      },
      {
        label: 'Direct Investment Audit',
        path: '/direct-investment',
        icon: FileText,
        keywords: 'dip direct investment audit trail',
      },
      {
        label: 'Industrial TIER Pack',
        path: '/industrial',
        icon: Building2,
        keywords: 'industrial tier compliance emitter',
      },
    ],
  },
  {
    ...
    items: [
      {
        label: 'Regulatory Filing Export',
        path: '/regulatory-filing',
        icon: FileText,
        keywords: 'oeb auc rule 005 filing',
      },
      {
        label: 'BYO-CSV Proof Generator',
        path: '/byo-csv-proof',
        icon: Shield,
        keywords: 'csv proof privacy local browser',
      },
      {
        label: 'Asset Health / CBRM',
        path: '/asset-health',
        icon: Activity,
        keywords: 'asset health cbrm scoring capex',
      },
      {
        label: 'Utility Security Statement',
        path: '/utility-security',
        icon: Shield,
        keywords: 'security procurement sbom',
      },
      {
        label: 'Bank-Ready Export',
        path: '/bank-export',
        icon: FileText,
        keywords: 'bank green loan export report',
      },
    ],
  },
  {
    ...
    items: [
      {
        label: 'GA/ICI 5CP Predictor',
        path: '/ga-ici-5cp',
        icon: TrendingUp,
        keywords: 'ontario ga ici 5cp peak demand',
      },
      {
        label: 'Shadow Billing',
        path: '/shadow-billing',
        icon: DollarSign,
        keywords: 'shadow billing invoice comparison',
      },
      {
        label: 'Bill Comparison',
        path: '/bill-comparison',
        icon: DollarSign,
        keywords: 'bill comparison rate alberta',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        path: '/hydrogen',
        icon: Zap,
        keywords: 'hydrogen economy hub production',
      },
      {
        label: 'Critical Minerals',
        path: '/critical-minerals',
        icon: Globe,
        keywords: 'minerals supply chain critical',
      },
      {
        label: 'AI Data Centres',
        path: '/ai-data-centre',
        icon: Cpu,
        keywords: 'ai data centre datacenter load',
      },
      {
        label: 'Landfill Methane',
        path: '/landfill-methane',
        icon: Leaf,
        keywords: 'methane landfill gas capture',
      },
      {
        label: 'Arctic Energy Security',
        path: '/arctic-energy',
        icon: Globe,
        keywords: 'arctic energy security north',
      },
      {
        label: 'Digital Twin',
        path: '/digital-twin',
        icon: Cpu,
        keywords: 'digital twin simulation model',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        path: '/indigenous',
        icon: Users,
        keywords: 'indigenous energy ocap sovereignty',
      },
      {
        label: 'Funder Reporting',
        path: '/funder-reporting',
        icon: FileText,
        keywords: 'indigenous funder report aicei',
      },
      {
        label: 'AICEI Reporting',
        path: '/aicei',
        icon: FileText,
        keywords: 'aicei indigenous climate energy',
      },
      {
        label: 'Sovereign Data Vault',
        path: '/ocap-data',
        icon: Shield,
        keywords: 'ocap data sovereignty vault',
      },
      {
        label: 'Municipal Climate Tools',
        path: '/for-municipalities',
        icon: Building2,
        keywords: 'municipal climate fcm aicei',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        label: 'Ask Data (NL2SQL)',
        path: '/ask-data',
        icon: Search,
        keywords: 'nl2sql natural language query',
      },
      {
        label: 'Agent Runner',
        path: '/workflows',
    ...
    items: [
      {
        ...
        path: '/watchdog',
        icon: DollarSign,
        keywords: 'rate watchdog alberta retailer',
      },
      { label: 'RRO Alerts', path: '/rro', icon: DollarSign, keywords: 'rro rate alert regulated' },
      {
        label: 'Retailer Hedging',
        path: '/hedging',
        icon: TrendingUp,
        keywords: 'retailer hedging tools',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: GraduationCap,
        keywords: 'training coordinator cohort',
      },
      {
        label: 'Certificates',
        path: '/certificates',
        icon: GraduationCap,
        keywords: 'certificate track module',
      },
      {
        label: 'Badges',
        path: '/badges',
        icon: GraduationCap,
        keywords: 'badge achievement gamification',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: '/enterprise',
        icon: Building2,
        keywords: 'enterprise sales contact',
      },
      {
        label: 'Compare vs Competitors',
        path: '/compare',
        icon: Search,
        keywords: 'competitor comparison vs',
      },
      {
        label: 'Pilot Readiness',
        path: '/pilot-readiness',
        icon: FileText,
        keywords: 'pilot evidence readiness',
      },
      {
        label: 'Solutions Navigator',
        path: '/solutions',
        icon: Search,
        keywords: 'solutions use cases',
      },
    ],
  },
  {
