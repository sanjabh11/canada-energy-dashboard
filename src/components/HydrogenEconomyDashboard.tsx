  ...
  return (
    <div className="min-h-screen bg-primary p-6">
      ...
      <div className="card p-4 mb-8">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <select
            ...
            className="px-4 py-2 border border-[var(--border-medium)] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          >
      ...
      <div className="card p-6 mb-8">
        ...
        <div className="grid grid-cols-2 gap-6 mt-6">
          <div className="p-4 bg-secondary rounded-lg">
            ...
            <p className="text-xs text-success mt-2">🏆 Industrial Heartland - Air Products $1.3B Complex</p>
          </div>
          <div className="p-4 bg-secondary rounded-lg">
            ...
            <p className="text-xs text-electric mt-2">🚆 Calgary-Banff H₂ Rail + ATCO Demonstrations</p>
          </div>
        </div>
      </div>
          ...
          <div className="mt-4 space-y-2 text-sm">
            <div className="flex items-center justify-between p-2 bg-secondary rounded">
              <span className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-secondary0"></div>
            ...
            <div className="mt-3 p-3 bg-secondary border border-blue-200 rounded">
          ...
          {data.summary.pricing && (
            <div className="grid grid-cols-3 gap-4 mt-4">
              <div className="p-3 bg-secondary rounded-lg">
                ...
                <div className="text-2xl font-bold text-electric">${data.summary.pricing.current_price_cad_per_kg.toFixed(2)}/kg</div>
              </div>
              <div className="p-3 bg-secondary rounded-lg">
                <div className="text-xs text-secondary">Yearly Average</div>
                <div className="text-2xl font-bold text-success">${data.summary.pricing.yearly_average.toFixed(2)}/kg</div>
              </div>
              <div className={`p-3 ${data.summary.pricing.weekly_change_percentage >= 0 ? 'bg-secondary' : 'bg-secondary'} rounded-lg`}>
                <div className="text-xs text-secondary">Weekly Change</div>
                <div className={`text-2xl font-bold ${data.summary.pricing.weekly_change_percentage >= 0 ? 'text-danger' : 'text-success'}`}>
      ...
      {data.price_forecasts && data.price_forecasts.length > 0 && (
        <div className="card p-6 mb-8">
          <div className="mb-6 p-4 bg-secondary border-l-4 border-success rounded-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-primary mb-3 flex items-center gap-2">
                <Factory className="w-5 h-5 text-electric" />
              ...
              <table className="min-w-full divide-y divide-[var(--border-subtle)]">
                ...
                <tbody className="bg-secondary divide-y divide-[var(--border-subtle)]">
                  {data.price_forecasts
                    ...
                    .map((forecast, idx) => (
                      <tr key={forecast.id} className={`hover:bg-secondary ${forecast.forecast_year === 2035 ? 'bg-secondary font-semibold' : ''}`}>
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-primary">
                          {forecast.forecast_year}
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-right text-success font-semibold">
                          ${forecast.green_h2_price_cad_per_kg.toFixed(2)}/kg
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-right text-electric font-semibold">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="p-4 bg-secondary border-2 border-blue-200 rounded-lg">
            ...
            <div className="p-4 bg-secondary border-2 border-green-300 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
            ...
            <div className="p-4 bg-secondary border-2 border-red-200 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
      ...
      <div className="card p-6 mb-8">
        ...
        <div className="space-y-4">
          {data.projects.slice(0, 5).map((project) => (
            <div key={project.id} className="p-4 border border-[var(--border-subtle)] rounded-lg hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between mb-2">
                ...
                <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                  project.status === 'Operational' ? 'bg-green-100 text-success' :
                  project.status === 'Under Construction' ? 'bg-blue-100 text-electric' :
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                ...
                <div>
                  ...
                  <div className="font-semibold text-success">${(project.federal_funding_cad / 1e6).toFixed(0)}M</div>
                </div>
              </div>
              {project.part_of_hub && (
