...
function renderMarkdown(payload) {
  ...
  return `${[
    ...
    '',
    renderTable(['Probe', 'Command', 'Status', 'Current', 'Expected', 'Diagnostic Command', 'Diagnostic Current', 'Diagnostic Boundary', 'Next Action', 'Proof Boundary', 'Stop Gate'], probeRows),
    '',
    '## Release Preflight Deficits',
    '',
    releasePreflight.evidence ?? 'Release preflight deficit ledger missing.',
    '',
    renderTable(['Requirement', 'Current', 'Needed', 'Status', 'Proof Command', 'Proof Type', 'Proof Boundary', 'Stop Gate'], deficitRows),
    '',
