...
console.log('');
console.log('Next register update command:');
console.log(`pnpm run update:pilot-evidence-register-row -- --register-file path/to/filled-pilot-evidence-register.csv --evidence-root ${displayEvidenceRoot} --evidence-file-reference ${evidenceReference} --confidence-delta "<explicit 0..0.4, or 0 for staging>" --output-file path/to/updated-pilot-evidence-register.csv`);
console.log('');
