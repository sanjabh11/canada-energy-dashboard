...
function assertReport(markdown, options = {}) {
  ...
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-BRANCH-REVIEW-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the branch review public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused branch handle digest'), 'Code optimization report must record the selected minimal branch review public-handle digest.');
  assert(/does not checkout|merge|push|discard|delete|select canonical heads|run migrations|mutate Supabase|deploy|request production approval|hosted\/live parity|grant owner approval|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the branch handle digest no-branch-mutation, no-migration, no-approval, no-deploy, and no-readiness boundary.');
  ...
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-SUPABASE-ADVISOR-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the Supabase advisor public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused Supabase advisor handle digest'), 'Code optimization report must record the selected minimal Supabase advisor public-handle digest.');
  assert(/does not authorize connectors|access dashboards|rerun Security Advisor or Performance Advisor|mutate the database|run migrations|record secrets|clear advisor findings|request production approval|hosted\/live parity|grant owner approval|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the Supabase handle digest no-authorization, no-dashboard, no-advisor-rerun, no-database-mutation, no-secret, no-approval, no-deploy, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-BUYER-EVIDENCE-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the buyer evidence public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused buyer evidence handle digest'), 'Code optimization report must record the selected minimal buyer evidence public-handle digest.');
  assert(/does not contact buyers|send outreach|create accepted evidence|move confidence|attach retained artifacts|validate 95%|create buyer proof|claim buyer acceptance|request production approval|hosted\/live parity|grant owner approval|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the buyer evidence handle digest no-contact, no-outreach, no-evidence-generation, no-retained-artifact, no-95-validation, no-approval, no-deploy, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-PRODUCTION-APPROVAL-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the production approval public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused production approval handle digest'), 'Code optimization report must record the selected minimal production approval public-handle digest.');
  assert(/does not request owner approval|grant owner approval|run deploy-production|run Netlify deploy|push|merge|mutate branches|contact buyers|access Supabase|clear source provenance|run release-readiness|run check:production-deploy-request as clearance|hosted\/live parity|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the production approval handle digest no-approval-request, no-deploy, no-source-or-branch-mutation, no-buyer-contact, no-Supabase, no-release-readiness, no-deploy-request-clearance, no-live-proof, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-POST-DEPLOY-LIVE-PROOF-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the post-deploy live-proof public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused post-deploy live-proof handle digest'), 'Code optimization report must record the selected minimal post-deploy live-proof public-handle digest.');
  assert(/does not request owner approval|grant owner approval|run deploy-production|run Netlify deploy|push|rebuild|mutate Netlify|access live accounts|run live metadata checks as clearance|run live static parity as clearance|run hosted browser smoke|prove current-source hosted parity|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the post-deploy live-proof handle digest no-approval, no-deploy, no-Netlify-mutation, no-live-account, no-live-check-clearance, no-browser-smoke, no-parity, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-LAUNCH-ACTION-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the launch-action public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused launch-action handle digest'), 'Code optimization report must record the selected minimal launch-action public-handle digest.');
  assert(/does not execute launch actions|commit|unstage|clear source provenance|run release-readiness|checkout branches|merge|push|select canonical heads|contact buyers|authorize Supabase|request owner approval|grant owner approval|deploy|mutate live services|browser smoke|hosted\/live parity|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the launch-action handle digest no-execution, no-source-mutation, no-release, no-branch, no-external-action, no-approval, no-deploy, no-live-proof, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-LAUNCH-EVIDENCE-VALIDATION-PUBLIC-HANDLE-LINEAGE'), 'Code optimization report must record the launch evidence validation public-handle lineage task.');
  assert(codeOptimizationSection.includes('minimal focused validation public-handle lineage'), 'Code optimization report must record the selected minimal launch evidence validation public-handle lineage.');
  assert(/does not self-certify|clear source provenance|run release-readiness|request owner approval|contact buyers|authorize Supabase|deploy|mutate live services|buyer acceptance|hosted\/live parity|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the validation lineage no-self-certification, no-source, no-release, no-approval, no-external-action, no-deploy, no-live-proof, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-OBJECTIVE-COMPLETION-AUDIT-PUBLIC-HANDLE-LINEAGE'), 'Code optimization report must record the objective completion audit public-handle lineage task.');
  assert(codeOptimizationSection.includes('minimal focused objective completion public-handle lineage'), 'Code optimization report must record the selected minimal objective completion audit public-handle lineage.');
  assert(/does not mark the launch goal complete|clear P0\/P1 blockers|collect buyer evidence|contact buyers|authorize Supabase|approve branches|resolve source provenance|run release-readiness as clearance|request owner approval|grant owner approval|deploy|mutate live services|buyer acceptance|hosted\/live parity|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the objective completion lineage no-completion, no-clearance, no-buyer, no-Supabase, no-branch, no-source, no-release, no-approval, no-deploy, no-live-proof, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-ADVERSARIAL-REVIEW-PUBLIC-HANDLE-LINEAGE'), 'Code optimization report must record the adversarial review public-handle lineage task.');
  assert(codeOptimizationSection.includes('minimal focused adversarial review public-handle lineage'), 'Code optimization report must record the selected minimal adversarial review public-handle lineage.');
  assert(/does not generate new review findings|clear launch blockers|create buyer evidence|contact buyers|buyer acceptance|authorize Supabase|clear Supabase advisor findings|approve branches|resolve source provenance|run release-readiness as clearance|request owner approval|grant owner approval|deploy|mutate live services|hosted\/live parity|mark the launch goal complete|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the adversarial lineage no-new-review, no-clearance, no-buyer, no-Supabase, no-branch, no-source, no-release, no-approval, no-deploy, no-live-proof, no-completion, and no-readiness boundary.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-PROGRESS-DIGEST-PUBLIC-HANDLE-LINEAGE'), 'Code optimization report must record the progress digest public-handle lineage task.');
  assert(codeOptimizationSection.includes('minimal focused progress digest public-handle lineage'), 'Code optimization report must record the selected minimal progress digest public-handle lineage.');
  assert(/does not complete pending work|clear launch blockers|run missing checks as clearance|collect buyer evidence|contact buyers|buyer acceptance|authorize Supabase|approve branches|resolve source provenance|run release-readiness as clearance|request owner approval|grant owner approval|deploy|mutate live services|hosted\/live parity|mark the launch goal complete|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the progress lineage no-completion, no-clearance, no-buyer, no-Supabase, no-branch, no-source, no-release, no-approval, no-deploy, no-live-proof, no-completion, and no-readiness boundary.');
	  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-UNMERGED-BRANCH-PACKAGE-HANDLES'), 'Code optimization report must record the unmerged branch package-handle task.');
	  assert(codeOptimizationSection.includes('minimal unmerged branch package-handle digest'), 'Code optimization report must record the selected minimal unmerged branch package-handle digest.');
	  assert(/does not checkout branches|merge branches|push branches|discard refs|select canonical heads|clear branch review|clear source provenance|run release-readiness as clearance|collect buyer evidence|contact buyers|authorize Supabase|request owner approval|grant owner approval|deploy|mutate live services|hosted\/live parity|mark the launch goal complete|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the unmerged branch package-handle no-checkout, no-merge, no-push, no-discard, no-canonical-selection, no-clearance, no-buyer, no-Supabase, no-approval, no-deploy, no-live-proof, no-completion, and no-readiness boundary.');
		  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-BUYER-EVIDENCE-READINESS-REPORT-CONTRACT'), 'Code optimization report must record the buyer evidence readiness report-contract task.');
		  assert(codeOptimizationSection.includes('minimal buyer evidence readiness report/check contract'), 'Code optimization report must record the selected minimal buyer evidence readiness report/check contract.');
		  assert(/does not contact buyers|send outreach|create accepted evidence|create buyer proof|move confidence|attach retained artifacts|validate 95%|clear the buyer hard gate|request production approval|grant owner approval|deploy|mutate live services|hosted\/live parity|mark the launch goal complete|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the buyer readiness report-contract no-contact, no-outreach, no-proof, no-retained-artifact, no-95-validation, no-approval, no-deploy, no-live-proof, no-completion, and no-readiness boundary.');
	  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-FOCUSED-LAUNCH-READINESS-SUITE-PACKAGE-HANDLES'), 'Code optimization report must record the focused launch-readiness suite package-handle task.');
	  assert(codeOptimizationSection.includes('minimal aggregate suite package-handle digest'), 'Code optimization report must record the selected minimal aggregate suite package-handle digest.');
	  assert(/package-handle discoverability only|does not run focused reports as clearance|clear source provenance|run release-readiness|choose canonical branch heads|authorize Supabase|contact buyers|create buyer proof|request or grant owner approval|push|deploy|mutate live services|hosted\/live parity|mark the launch goal complete|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve focused suite package-handle no-clearance, no-release, no-branch, no-Supabase, no-buyer, no-approval, no-deploy, no-live-proof, no-completion, and no-readiness boundaries.');
  ...
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-FOCUSED-LAUNCH-READINESS-SUITE-HANDOFF-SURFACES'), 'Code optimization report must record the focused launch-readiness suite handoff-surface task.');
  assert(codeOptimizationSection.includes('minimal manifest handoff-surface alignment'), 'Code optimization report must record the selected minimal focused launch-readiness suite handoff alignment.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-SOURCE-PROVENANCE-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the source provenance public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused source handle digest'), 'Code optimization report must record the selected minimal source provenance public-handle digest.');
  assert(codeOptimizationSection.includes('CEIP-SAFE-FIX-RELEASE-PREFLIGHT-PUBLIC-HANDLE-DIGEST'), 'Code optimization report must record the release preflight public-handle digest task.');
  assert(codeOptimizationSection.includes('minimal focused release handle digest'), 'Code optimization report must record the selected minimal release preflight public-handle digest.');
  assert(/does not install Corepack|enable Corepack|install Git LFS|run release-readiness|clear source provenance|push|deploy|hosted\/live parity|grant owner approval|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve the release preflight handle digest non-install, non-release, non-clearance, non-approval, non-deploy, and non-readiness boundary.');
  ...
  assert(/handoff discoverability only|does not run focused reports as clearance|clear source provenance|run release-readiness|choose canonical branch heads|authorize Supabase|contact buyers|request or grant owner approval|push|deploy|hosted\/live parity|mark the launch goal complete|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve focused launch-readiness suite handoff no-clearance, no-approval, no-deploy, no-live-proof, and no-readiness boundaries.');
  assert(/handle discoverability only|does not commit|unstage|stash|revert|delete|rename|move|choose owner intent|clear source provenance|run release-readiness|push|deploy|request production approval|grant owner approval|hosted\/live parity|mark the launch goal complete|raise launch status/i.test(codeOptimizationSection), 'Code optimization report must preserve source provenance public-handle digest no-mutation, no-clearance, no-approval, no-deploy, no-live-proof, and no-readiness boundaries.');
