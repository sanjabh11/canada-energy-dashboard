...
for (let index = 0; index < args.length; index += 1) {
  ...
  if (arg.startsWith('--')) {
    ...
    if (!['output', 'release-readiness-proof', 'supabase-app-lint-proof'].includes(key)) {
      ...
      if (key === 'release-readiness-proof') manifestArgs.push('--release-readiness-proof', value);
...
function focusedPayload(manifest) {
  ...
  return {
    ...
    package_script_handles: {
      ...
      record_release_readiness_proof: 'corepack pnpm run record:release-readiness-proof -- --output <path>',
