...
function validateManifest(manifest) {
  ...
  if (!/production approval request packet rows|execution gates|clean_source_provenance_first|attach_manifest_validation_evidence|release_readiness_after_clean_source|branch_review_before_owner_request|supabase_advisor_after_authorization|buyer_evidence_before_commercial_ready_claims|owner_approval_after_pre_request_gates|post_deploy_proof_after_approved_deploy|pre_request|market_confidence_boundary|owner_decision|post_deploy_boundary|blocks_approval_request|owner_decision_required|can_execute_from_packet=false/i.test(`${productionApprovalOperatorHandoffPacket.evidenceBoundary ?? ''}\n${productionApprovalOperatorHandoffPacket.nextAction ?? ''}`)) {
