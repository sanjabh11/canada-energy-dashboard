...
('h2-ab-004', 'Medicine Hat Blue Hydrogen Plant', 'ATCO', 'Production', 'Medicine Hat', 'AB', 50.0407, -110.6764, 'Blue', 'Steam Methane Reforming (SMR)', 50000, NULL, 'Planning', '2025-03-20', '2028-01-01', 400000000, TRUE, 90, NULL, NULL, ARRAY['Private'], 'Blue hydrogen with CCUS for industrial users'),
('h2-ab-005', 'Fort Saskatchewan Green H2 Hub', 'Canadian Green Hydrogen', 'Production', 'Fort Saskatchewan', 'AB', 53.7134, -113.2105, 'Green', 'Alkaline Electrolysis', 20000, 50, 'Planning', '2024-11-10', '2027-06-01', 350000000, FALSE, NULL, 'Wind + Solar', 'Edmonton Hub', ARRAY['Federal', 'Private'], '50 MW electrolyser powered by dedicated renewable energy')
