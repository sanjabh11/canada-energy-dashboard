...
const ENDPOINT_LIMITS: Record<string, { windowMs: number; maxRequests: number }> = {
  ...
  'ml-forecast': { windowMs: 60 * 1000, maxRequests: 20 },
  'groundsource-miner': { windowMs: 60 * 1000, maxRequests: 5 },
  'tier-simulator': { windowMs: 60 * 1000, maxRequests: 30 },
  'rate-watchdog': { windowMs: 60 * 1000, maxRequests: 30 },
  'grid-risk': { windowMs: 60 * 1000, maxRequests: 20 },
  'model-monitor': { windowMs: 60 * 1000, maxRequests: 20 },
