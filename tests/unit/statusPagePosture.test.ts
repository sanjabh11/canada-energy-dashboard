...
describe('status page release posture', () => {
  ...
  it('exposes public-safe release health evidence without turning source CI into production deploy proof', () => {
    ...
    expect(productionApprovalQueueEvidence?.sourceManifestPath).toBe('production_approval.prerequisite_queue');
    expect(productionApprovalQueueEvidence?.sourceProofTypes).toEqual([
      'source_provenance_decision',
      'manifest_validation',
      'gated_release_command',
      'read_only_branch_review',
    ...
    expect(productionApprovalRequestPacketEvidence?.sourceManifestPath).toBe('production_approval.request_packet');
    expect(productionApprovalRequestPacketEvidence?.sourceProofTypes).toEqual([
    ...
    expect(productionApprovalOperatorHandoffPacketEvidence?.sourceManifestPath).toBe('production_approval.operator_handoff_packet');
    expect(productionApprovalOperatorHandoffPacketEvidence?.sourceProofTypes).toEqual([
    ...
    expect(supabaseClearanceDeficitLedgerEvidence?.sourceManifestPath).toBe('supabase_advisor.clearance_deficits');
    expect(supabaseClearanceDeficitLedgerEvidence?.sourceProofTypes).toEqual([
      'repo_command',
      'external_account_evidence',
    ...
    expect(supabaseOperatorHandoffPacketEvidence?.sourceManifestPath).toBe('supabase_advisor.operator_handoff_packet');
    expect(supabaseOperatorHandoffPacketEvidence?.sourceProofTypes).toEqual([
    ...
    expect(supabaseRemediationQueueEvidence?.sourceManifestPath).toBe('supabase_advisor.clearance_deficits.remediation_queue');
    expect(supabaseRemediationQueueEvidence?.sourceProofTypes).toEqual([
      'repo_command',
      'external_account_evidence',
      'retained_redacted_record',
    ]);
    ...
    expect(supabaseAdvisorEvidence?.sourceManifestPath).toBe('supabase_advisor');
    expect(supabaseAdvisorEvidence?.sourceProofTypes).toEqual([
      'repo_command',
      'external_account_evidence',
    ]);
  ...
  it('defines a public-safe release status manifest for the status page', () => {
    ...
    expect(productionApprovalQueueGate?.sourceManifestPath).toBe('production_approval.prerequisite_queue');
    expect(productionApprovalQueueGate?.sourceProofTypes).toEqual([
      'source_provenance_decision',
      'manifest_validation',
      'gated_release_command',
      'read_only_branch_review',
    ...
    expect(productionApprovalRequestPacketGate?.sourceManifestPath).toBe('production_approval.request_packet');
    expect(productionApprovalRequestPacketGate?.sourceProofTypes).toEqual([
      'production_approval_request_packet',
      'source_provenance_decision',
      'manifest_validation',
      'gated_release_command',
    ...
    expect(productionApprovalOperatorHandoffPacketGate?.sourceManifestPath).toBe('production_approval.operator_handoff_packet');
    expect(productionApprovalOperatorHandoffPacketGate?.sourceProofTypes).toEqual([
      'production_approval_operator_handoff_packet',
      'source_provenance_decision',
      'manifest_validation',
      'gated_release_command',
    ...
    expect(advisorGate?.sourceManifestPath).toBe('supabase_advisor');
    expect(advisorGate?.sourceProofTypes).toEqual([
      'repo_command',
      'external_account_evidence',
    ]);
    ...
    expect(supabaseClearanceDeficitLedgerGate?.sourceManifestPath).toBe('supabase_advisor.clearance_deficits');
    expect(supabaseClearanceDeficitLedgerGate?.sourceProofTypes).toEqual([
      'repo_command',
      'external_account_evidence',
      'retained_redacted_record',
    ]);
    ...
    expect(supabaseOperatorHandoffPacketGate?.sourceManifestPath).toBe('supabase_advisor.operator_handoff_packet');
    expect(supabaseOperatorHandoffPacketGate?.sourceProofTypes).toEqual([
      'supabase_advisor_operator_handoff_packet',
      'repo_command',
      'external_account_evidence',
      'retained_redacted_record',
    ...
    expect(supabaseRemediationQueueGate?.sourceManifestPath).toBe('supabase_advisor.clearance_deficits.remediation_queue');
    expect(supabaseRemediationQueueGate?.sourceProofTypes).toEqual([
      'repo_command',
      'external_account_evidence',
      'retained_redacted_record',
    ]);
